...
import { MemorizeInstanceType, Memorize } from "../utils/memorize"
...
function cache(map: MemorizeInstanceType, key: any, value: any, options: ToJSOptions): any {
...
function toJSHelper(source, options: ToJSOptions, __alreadySeen: MemorizeInstanceType) {
...
export function toJS(source, options: ToJSOptions) {
    ...
    let __alreadySeen
    if (detectCycles) __alreadySeen = new Memorize()
